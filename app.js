...
//returns the number of pixels the document has been 
//scrolled vertically.
// slice extracts a section of a string without modifying
// original string
//offsetTop - A Number, representing the top position of the element,
// in pixels


// select logo and change the damn link color and shit 
const logo = document.querySelector(".logo")
logo.innerHTML.toLowerCase()
